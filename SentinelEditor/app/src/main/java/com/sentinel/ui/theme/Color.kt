...
val EditorQuoteBorderLight = Color(0xFF90A4AE)
val EditorQuoteBorderDark = Color(0xFF7F94A0)
val EditorQuoteTextLight = Color(0xFF546E7A)
val EditorQuoteTextDark = Color(0xFFC1CED6)
val EditorTaskMarkerLight = Color(0xFF37474F)
val EditorTaskMarkerDark = Color(0xFFE2E8F0)
val EditorCodeBackgroundLight = Color(0xFFECEFF1)
val EditorCodeBackgroundDark = Color(0xFF2B313C)
val EditorCodeTextLight = Color(0xFF263238)
val EditorCodeTextDark = Color(0xFFE6EDF3)
val EditorLinkLight = Color(0xFF1565C0)
val EditorLinkDark = Color(0xFF8AB4FF)
val EditorCursorLineLight = Color(0xFF37474F)
val EditorCursorLineDark = Color(0xFF8A99A8)
